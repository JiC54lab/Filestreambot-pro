...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '157.90.181.183'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '157.90.181.183:22203')) if not ON_HEROKU or getenv('FQDN', '157.90.181.183:22203') else APP_NAME+'.herokuapp.com'
